# Claude Rails Kit Aliases (Bash/Zsh)
# Source this file in your .zshrc or .bashrc

export CLAUDE_KIT_PATH="$HOME/.claude/dev-kit"
GLOBAL_CTX="$CLAUDE_KIT_PATH/GLOBAL_RULES.md"
...
# Project Setup
alias claude-init='cp "$CLAUDE_KIT_PATH/templates/CLAUDE.md" ./CLAUDE.md && echo "✅ Initialized CLAUDE.md in current directory."'
